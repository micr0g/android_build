...
$(combo_target)GLOBAL_CFLAGS := -Ofast -fno-exceptions -Wno-multichar
$(combo_target)RELEASE_CFLAGS := -Ofast -fgcse-las
$(combo_target)GLOBAL_LDFLAGS := -Ofast -Wl,--relax -Wl,--sort-common -Wl,--gc-sections
